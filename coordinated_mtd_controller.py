...
class CoordinatedPortShuffleMTD(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        wsgi = kwargs['wsgi']
        wsgi.register(PortRESTAPI, {'coordinator': self})
        # Periodic shuffle thread
    ...
    def _coordinated_shuffle(self, datapath):
        ...
        # Keep old port flow for soft handover
...
class PortRESTAPI(ControllerBase):
